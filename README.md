...
The current version adds Batch Edit mode with mode tabs, table-based metadata editing, selected-row batch field changes, sortable and resizable columns, and folder-scoped editing.
